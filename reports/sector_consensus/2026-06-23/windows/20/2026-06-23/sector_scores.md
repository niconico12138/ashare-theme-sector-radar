...
**分析日期**: 2026-06-23
**更新时间**: 2026-07-01T22:35:03.240950
...
|------|------|--------|----------|--------|----------|---------|
| 1 | 化学制药 | 26.0 | 回避 | 63.8 | 短线中性 | neutral |
| 2 | 养殖业 | 23.0 | 回避 | 52.8 | 短线中性 | neutral |
| 3 | 旅游及酒店 | 23.0 | 回避 | 52.8 | 短线中性 | neutral |
| 4 | 中药 | 20.0 | 回避 | 52.8 | 短线中性 | neutral |
| 5 | 医药商业 | 20.0 | 回避 | 52.8 | 短线中性 | neutral |
| 6 | 公路铁路运输 | 18.0 | 回避 | 52.8 | 短线中性 | neutral |
| 7 | 医疗器械 | 18.0 | 回避 | 55.8 | 短线中性 | neutral |
| 8 | 医疗服务 | 18.0 | 回避 | 58.8 | 短线中性 | neutral |
| 9 | 厨卫电器 | 18.0 | 回避 | 49.8 | 短线回落 | weak_or_cooling |
| 10 | 家居用品 | 16.0 | 回避 | 52.8 | 短线中性 | neutral |

## 短线爆发 Top 10

| 排名 | 板块 | 短线分 | 短线等级 | 趋势分 | 趋势等级 | Profile |
|------|------|--------|----------|--------|----------|---------|
| 1 | 化学制药 | 63.8 | 短线中性 | 26.0 | 回避 | neutral |
| 2 | 医疗服务 | 58.8 | 短线中性 | 18.0 | 回避 | neutral |
| 3 | 医疗器械 | 55.8 | 短线中性 | 18.0 | 回避 | neutral |
| 4 | 养殖业 | 52.8 | 短线中性 | 23.0 | 回避 | neutral |
| 5 | 旅游及酒店 | 52.8 | 短线中性 | 23.0 | 回避 | neutral |
| 6 | 中药 | 52.8 | 短线中性 | 20.0 | 回避 | neutral |
| 7 | 医药商业 | 52.8 | 短线中性 | 20.0 | 回避 | neutral |
| 8 | 公路铁路运输 | 52.8 | 短线中性 | 18.0 | 回避 | neutral |
| 9 | 家居用品 | 52.8 | 短线中性 | 16.0 | 回避 | neutral |
| 10 | 厨卫电器 | 49.8 | 短线回落 | 18.0 | 回避 | weak_or_cooling |
