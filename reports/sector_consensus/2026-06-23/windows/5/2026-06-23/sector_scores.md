...
**分析日期**: 2026-06-23
**更新时间**: 2026-07-01T22:35:03.210316
...
|------|------|--------|----------|--------|----------|---------|
| 1 | 医疗服务 | 50.0 | 中性 | 58.8 | 短线中性 | neutral |
| 2 | 化学制药 | 45.0 | 降温 | 63.8 | 短线中性 | neutral |
| 3 | 医疗器械 | 31.8 | 回避 | 55.8 | 短线中性 | neutral |
| 4 | 养殖业 | 23.0 | 回避 | 52.8 | 短线中性 | neutral |
| 5 | 公路铁路运输 | 20.8 | 回避 | 52.8 | 短线中性 | neutral |
| 6 | 中药 | 20.0 | 回避 | 52.8 | 短线中性 | neutral |
| 7 | 医药商业 | 20.0 | 回避 | 52.8 | 短线中性 | neutral |
| 8 | 厨卫电器 | 16.8 | 回避 | 49.8 | 短线回落 | weak_or_cooling |
| 9 | 家居用品 | 16.8 | 回避 | 52.8 | 短线中性 | neutral |
| 10 | 旅游及酒店 | 16.0 | 回避 | 52.8 | 短线中性 | neutral |

## 短线爆发 Top 10

| 排名 | 板块 | 短线分 | 短线等级 | 趋势分 | 趋势等级 | Profile |
|------|------|--------|----------|--------|----------|---------|
| 1 | 化学制药 | 63.8 | 短线中性 | 45.0 | 降温 | neutral |
| 2 | 医疗服务 | 58.8 | 短线中性 | 50.0 | 中性 | neutral |
| 3 | 医疗器械 | 55.8 | 短线中性 | 31.8 | 回避 | neutral |
| 4 | 养殖业 | 52.8 | 短线中性 | 23.0 | 回避 | neutral |
| 5 | 公路铁路运输 | 52.8 | 短线中性 | 20.8 | 回避 | neutral |
| 6 | 中药 | 52.8 | 短线中性 | 20.0 | 回避 | neutral |
| 7 | 医药商业 | 52.8 | 短线中性 | 20.0 | 回避 | neutral |
| 8 | 家居用品 | 52.8 | 短线中性 | 16.8 | 回避 | neutral |
| 9 | 旅游及酒店 | 52.8 | 短线中性 | 16.0 | 回避 | neutral |
| 10 | 厨卫电器 | 49.8 | 短线回落 | 16.8 | 回避 | weak_or_cooling |
