...
def build_default_strategy_versions() -> list[StrategyVersion]:
    ...
    return [
        ...
        StrategyVersion(
            ...
            "v26 risk-control setup plus turnover depth and failed-breakout cashout guard.",
            (
                FactorCondition("open_to_midday_resilience_score", ">=", 53.0),
                FactorCondition("midday_hold_score", ">=", 56.0),
                FactorCondition("vwap_above_ratio_score", ">=", 48.0),
                ...
                FactorCondition("optimized_watch_score", ">=", 75.36),
                FactorCondition("late_amount_surge_score", "<=", 50.0),
                FactorCondition("execution_turnover_depth_score", ">=", 70.0),
                FactorCondition("cashout_failed_late_breakout_risk", "<=", 50.0),
            ),
        ),
        StrategyVersion(
            "v29_operational_tradeability_turnover",
            "v26 risk-control setup plus tradeability and turnover depth.",
            (
                FactorCondition("open_to_midday_resilience_score", ">=", 53.0),
                FactorCondition("midday_hold_score", ">=", 56.0),
                FactorCondition("vwap_above_ratio_score", ">=", 48.0),
                ...
                FactorCondition("optimized_watch_score", ">=", 75.36),
                FactorCondition("late_amount_surge_score", "<=", 50.0),
                FactorCondition("execution_tradeability_score", ">=", 60.0),
                FactorCondition("execution_turnover_depth_score", ">=", 70.0),
            ),
        ),
        StrategyVersion(
            "v30_operational_position_turnover_guard",
            "v27 position setup plus turnover depth and failed-breakout cashout guard.",
            (
                FactorCondition("open_to_midday_resilience_score", ">=", 53.0),
                FactorCondition("midday_hold_score", ">=", 56.0),
                FactorCondition("vwap_above_ratio_score", ">=", 48.0),
